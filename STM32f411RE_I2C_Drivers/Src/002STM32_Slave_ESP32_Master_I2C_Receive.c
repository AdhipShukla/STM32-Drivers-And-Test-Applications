/*
 * 002STM32_Slave_ESP32_Master_I2C_Interrupt.c
 *
...
int main(void)
{
	...
	for(;;){
		if(MasterExample){
			...
			I2C_MasterSendData(&I2C1Handle, &CommandByte, 1, SLAVE_ADDR, I2C_SR_DISABLE);
			...
			I2C_MasterSendData(&I2C1Handle, &CommandByte, 1, SLAVE_ADDR, I2C_SR_DISABLE);
			//Get the data
			I2C_MasterReceiveData(&I2C1Handle, Rec_Buf, len, SLAVE_ADDR, I2C_SR_DISABLE);
			Rec_Buf[len+1]='\0';
			printf("Message: %s\n",Rec_Buf);
			/*while(Rec_Buf[i]!='\0'){
